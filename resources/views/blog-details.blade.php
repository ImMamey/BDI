...
@section('content')    
    ...
    <section class="blog-hero-section set-bg spad" data-setbg="../public/img/blog/details/details-hero.jpg">
        <div class="container">
                ...
                <div class="col-lg-10 m-auto">
                    <div class="bd-text">
                        ...
                        <div class="bd-pic">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{ asset('img/blog/details/bd-more-1.jpg') }}" alt="">
                                </div>
                                <div class="col-md-6">
                                    <img src="{{ asset('img/blog/details/bd-more-2.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bd-quote">
                            <img src="{{ asset('img/blog/details/quote.png') }}" alt="">
                        ...
                        <div class="blog-author">
                            <img src="{{ asset('img/blog/details/bd-posted.jpg') }}" alt="">
                            <h5>Shane Lynch</h5>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="blog-item">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="bi-pic set-bg" data-setbg="../public/img/blog/blog-1.jpg"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="bi-text">
                                    <ul>
                ...
                <div class="col-md-6">
                    <div class="blog-item">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="bi-pic set-bg" data-setbg="../public/img/blog/blog-2.jpg"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="bi-text">
                                    <ul>
                                    ...
                                    <div class="bt-author">
                                        <div class="ba-pic">
                                            <img src="../public/img/blog/author-1.jpg" alt="">
                                        </div>
                                        <div class="ba-text">
                                            <h5>Aaron Russell</h5>
                                            <span>Content</span>
