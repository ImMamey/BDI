...
@extends('layouts.app')
 @section('content')
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="member-item set-bg" data-setbg="../public/img/member/member-1.jpg">
                        <div class="mi-text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member-item set-bg" data-setbg="../public/img/member/member-2.jpg">
                        <div class="mi-text">
                            <p>Quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora
                                incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                            <div class="mt-title">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member-item set-bg" data-setbg="../public/img/member/member-3.jpg">
                        <div class="mi-text">
                            <p>Quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora
                                incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                            <div class="mt-title">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member-item set-bg" data-setbg="../public/img/member/member-4.jpg">
                        <div class="mi-text">
                            <p>Quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora
                                incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                            <div class="mt-title">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member-item set-bg" data-setbg="../public/img/member/member-5.jpg">
                        <div class="mi-text">
                            <p>Quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora
                                incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                            <div class="mt-title">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member-item set-bg" data-setbg="../public/img/member/member-6.jpg">
                        <div class="mi-text">
                            <p>Quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora
                                incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                            <div class="mt-title">
    ...
    <section class="callto-section set-bg" data-setbg="../public/img/ctc-bg.jpg">
        <div class="container">
            <div class="row">
